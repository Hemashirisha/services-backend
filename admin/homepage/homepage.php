...
<div class="w3-container w3-section iframe-container" class="w3-mobile">
    <form action='HomeTitle.php' method=POST id='frmTitle'>
...
<div class="w3-container w3-section" class="w3-mobile" >
    <form action='HomeHeading.php' method='POST' id='frmHeading'>
...
<div class="w3-container w3-section" class="w3-mobile">
    <form action='HomeContent.php' method='POST' id='frmContent'>
