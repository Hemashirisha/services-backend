...
$("#btnChangeLogo").click(function(){
    ...
    image.onload=function(){
        ...
        $.post('logoChange.php',{'logoName':logoName,id:$("#ChangeId").text()},function(data){
...
$("#btnChangeTitle").click(function(){
    ...
    $.post("titleChange.php",{"title":title,"id":$("#ChangeId").text()},function(data){
        alert(data);
...
$("#btnChangeDescr").click(function(){
    ...
    $.post("DescrChange.php",{"descr":descr,"id":$("#ChangeId").text()},function(data){
        alert(data);
...
$(".btnDelete").click(function(){
    ...
    var id=$(this).val();
    alert(id);
    $.post('deleteService.php',{'id':id},function(data){
        alert(data);
...
$("#submitNewService").click(function(){
    ...
    $.post("addService.php",{"logo":logoName,"title":title,"descr":descr},function(data){
        alert(data)
        location.reload(true);
